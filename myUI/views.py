...
def proj1Page(request):
    data_desc = pd.read_csv('myUI/data/desc.csv')
    col_desc = pd.read_csv('myUI/data/col_desc.csv')
    kill_counts = pd.read_csv('myUI/data/killCounts.csv')
    outlier_rate_tier = pd.read_csv('myUI/data/outlier_rate_tier.csv')
    outlier_rate_type = pd.read_csv('myUI/data/outlier_rate_type.csv')
    etc_per_kills = pd.read_csv('myUI/data/etc_per_kills.csv')
    numGroups_matchDuration = pd.read_csv('myUI/data/numGroups_matchDuration.csv')
    numGroups_matchDuration_squad = pd.read_csv('myUI/data/numGroups_matchDuration_squad.csv')
    numGroups_matchDuration_duo = pd.read_csv('myUI/data/numGroups_matchDuration_duo.csv')
    numGroups_matchDuration_solo = pd.read_csv('myUI/data/numGroups_matchDuration_solo.csv')
    numGroups_matchDuration_bronze = pd.read_csv('myUI/data/numGroups_matchDuration_bronze.csv')
    numGroups_matchDuration_silver = pd.read_csv('myUI/data/numGroups_matchDuration_silver.csv')
    numGroups_matchDuration_gold = pd.read_csv('myUI/data/numGroups_matchDuration_gold.csv')
    numGroups_matchDuration_platinum = pd.read_csv('myUI/data/numGroups_matchDuration_platinum.csv')
    numGroups_matchDuration_diamond = pd.read_csv('myUI/data/numGroups_matchDuration_diamond.csv')
    numGroups_matchDuration_master = pd.read_csv('myUI/data/numGroups_matchDuration_master.csv')
    kill_winPlacePerc_squad = pd.read_csv('myUI/data/kill_winPlacePerc_squad.csv')
    kill_winPlacePerc_duo = pd.read_csv('myUI/data/kill_winPlacePerc_duo.csv')
    kill_winPlacePerc_solo = pd.read_csv('myUI/data/kill_winPlacePerc_solo.csv')
    kill_winPlacePerc_bronze = pd.read_csv('myUI/data/kill_winPlacePerc_bronze.csv')
    kill_winPlacePerc_silver = pd.read_csv('myUI/data/kill_winPlacePerc_silver.csv')
    kill_winPlacePerc_gold = pd.read_csv('myUI/data/kill_winPlacePerc_gold.csv')
    kill_winPlacePerc_platinum = pd.read_csv('myUI/data/kill_winPlacePerc_platinum.csv')
    kill_winPlacePerc_diamond = pd.read_csv('myUI/data/kill_winPlacePerc_diamond.csv')
    kill_winPlacePerc_master = pd.read_csv('myUI/data/kill_winPlacePerc_master.csv')
    with open('myUI/data/reg_flat.pkl', 'rb') as f:
        data_flat = pickle.load(f)
    with open('myUI/data/kill_boxplot.pkl', 'rb') as f:
